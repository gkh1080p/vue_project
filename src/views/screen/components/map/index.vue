...
$.getJSON('https://geo.datav.aliyun.com/areas_v3/bound/geojson?code=100000_full', function (geoJson=chinaJSON) {
  echarts.registerMap('china', geoJson);
  let myChart = echarts.init(mapView.value);
  var option = {
